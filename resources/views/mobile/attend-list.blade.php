    ...
    <script>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    formatter: (function(cell) {
                        if (cell == '0') {
                            return gridjs.html(
                                `<span class="badge badge-pill badge-soft-danger font-size-12">Tidak Aktif</span>`
                            );
                        }
                        return gridjs.html(
        ...
        flatpickr("#datepicker-grade", {
            ...
            onChange: function(selectedDates, dateStr, instance) {
                location.href = "/record/month?grade=&month=" + dateStr
            },
        })
    </script>
@endsection
                                    ...
                                    <div class="mt-3 mt-md-0 mb-3">
                                        <a href="/quote/create"
                                            class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i
                                                class="mdi mdi-plus me-1"></i> Presensi</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end row -->
