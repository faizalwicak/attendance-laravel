          ...
          formatter: (function (cell) {
              return gridjs.html(`
                  <div class="d-flex gap-3">
                    <a href="/record/${cell[0]}" type="button" class="btn btn-primary btn-sm btn-rounded">Detail</a>
                  </div>`);
          })
        }
    ],
                ...
                <div class="row"> 
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control flatpickr-input" id="datepicker-periode" readonly="readonly" value="{{$selectedDay}}">
