            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <h4 class="mt-5">e-SensiSmansa</h4>
                        <p class="text-muted">Elektronik Presensi SMAN 1 Sleman</p>

                        <div class="row justify-content-center mt-5">
                            <div class="col-md-9">
                                <a href="/assets/apk/e-SensiSmansa.apk" class="btn btn-primary"
                                    id="button-email">Download Apk <i class="bx bx-download ms-1"></i></a>
                            </div> <!-- end col-->
                        </div> <!-- end row-->
                    </div>
                </div>
